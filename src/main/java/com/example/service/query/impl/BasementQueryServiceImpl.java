...
@Service
public class BasementQueryServiceImpl implements IBasementQueryService {

    @Autowired
    private JdbcTemplate jdbcTemplate;

    @Override
    public List<Map<String, Object>> getBasementList(int pageNumber, int pageSize) {
        String sql = "SELECT \n" +
                "t_farm.ID,\n" +
                "t_farm.Name,\n" +
                "t_farm.CTime,\n" +
        ...
        return jdbcTemplate.queryForList(
                getPageQuery(sql,"ID",pageSize,pageNumber)
        );
    }
}
